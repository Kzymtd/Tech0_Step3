...
if not st.session_state.page2:   
    ...
    html_message0 = "<p style='font-family: Hiragino Sans GB; text-align: center; font-size: 24px;'>新しい居住地。<br>転勤で引越しをするときは慌ただしく転居先を決める必要があります。<br>見知らぬ地への転勤であなたは大事にしたいポイントを押さえられていますか。<br>あなたが物件選びで重視したいポイントを教えてください。<br>「最終判断後押しくん」は物件情報だけではわからない、あなたが大事にするポイントをスコア化して<br>物件の最終決め手を後押しします。</p>"
...
##########################################################################################################
    ...
    # 画像のパス
    image_paths = [
        'image/OUTPUT_no1dammy.png',
        'image/OUTPUT_no2dammy.png',
        'image/OUTPUT_no3dammy.png'
    ]
